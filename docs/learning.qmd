...
post_meal_data |>
  ...
  rename(
    P.Glucose.minus = P.Glucose..5.OGTT,
    Insulin.minus = Insulin..5.OGTT.X
  )
...
post_meal_data |>
  mutate(
    percent_body_fat = (Weight / Fat.mass.DXA) * 100
  ) |>
...
post_meal_data |>
  ...
  summarise(
    "AUCc-Peptide" = median(round(auc_cp), 1),
    "AUC Glucose" = median(round(auc_pg), 1),
